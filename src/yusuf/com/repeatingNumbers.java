...
public class repeatingNumbers {
	...
	playAgain = sc.next().charAt(0);
	  ...
	  while(!end) {
		...
		System.out.println("Do you want to use pre-determined array or enter a new array to check for repeating numbers?: ");
		System.out.println("1- Pre-determined array : [1,2,5,9,8,11,5,2,4,5,7,12].");
