...
public static void selection() {
		...
		while(!end) {
			...
			System.out.println("Do you want to use already existing numbers or enter a new number to calculate?: ");
			...
			case 1:{
				...
				for(int i=0; i<3; i++) System.out.println("Sum of digits for "+array[i]+" is : "+addition(array[i]));
