...
public class numberGuessing {
	...
	public static void numberGuessingGame() {
		...
		do {
		     ...
		     System.out.println("The program has specified a random number between 0 and 20.\nYou have 5 attempts to guess this number.\n");
		     boolean end=false;
		...
		if(number >= 0 && number <= 20) { //check if input is in the acceptable range	  
	      if(number == int_random) {
	    	  System.out.println("\n*******************************************************************************");
	    	  System.out.println("Congratulations! You guessed the number correctly at your "+(counter+1)+". try!");
	    	  System.out.println("*******************************************************************************\n\n");
	    	  end=true;
	    	  playAgain = repeat();
	      }
	      if(number<int_random) {
	    	  counter++;
	    	  if(counter != 5) System.out.println("Tyr again! Hint: Number is BIGGER than your guess.\n");
	      }
	      if(number>int_random) {
	    	  counter++;
	    	  if(counter != 5) System.out.println("Tyr again! Hint: Number is SMALLER than your guess.\n");
	      }
	      if(counter == 5) {
			  System.out.println("\nYou FAILED! It was "+int_random+ "! The number was "+int_random+" all along!\n");
			  end=true;
			  playAgain = repeat();
		  }
		}//end of if loop
